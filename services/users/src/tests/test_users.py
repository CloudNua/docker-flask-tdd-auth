...
def test_single_user(test_app, test_database, add_user):
    user = add_user("jeffrey", "jeffrey@testdriven.io", "twoplustwo")
    client = test_app.test_client()
...
def test_all_users(test_app, test_database, add_user):
    ...
    add_user("michael", "michael@mherman.org", "twoplustwo")
    add_user("fletcher", "fletcher@notreal.com", "twoplustwo")
    client = test_app.test_client()
...
def test_remove_user(test_app, test_database, add_user):
    test_database.session.query(User).delete()
    user = add_user("user-to-be-removed", "remove-me@testdriven.io", "twoplustwo")
    client = test_app.test_client()
...
def test_update_user(test_app, test_database, add_user):
    user = add_user("user-to-be-updated", "update-me@testdriven.io", "twoplustwo")
    client = test_app.test_client()
    resp_one = client.put(
        f"/users/{user.id}",
...
def test_update_user_duplicate_email(test_app, test_database, add_user):
    add_user("hajek", "rob@hajek.org", "twoplustwo")
    user = add_user("rob", "rob@notreal.com", "twoplustwo")
